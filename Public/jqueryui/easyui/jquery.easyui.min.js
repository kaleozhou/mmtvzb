...
(function($){
function init(_1eb){
$(_1eb).addClass("__tooltip-f");
};
function _1ec(_1ed){
var opts=$.data(_1ed,"__tooltip").options;
$(_1ed).unbind(".__tooltip").bind(opts.showEvent+".__tooltip",function(e){
$(_1ed).__tooltip("show",e);
}).bind(opts.hideEvent+".__tooltip",function(e){
$(_1ed).__tooltip("hide",e);
}).bind("mousemove.__tooltip",function(e){
if(opts.trackMouse){
opts.trackMouseX=e.pageX;
opts.trackMouseY=e.pageY;
$(_1ed).__tooltip("reposition");
}
});
};
function _1ee(_1ef){
var _1f0=$.data(_1ef,"__tooltip");
if(_1f0.showTimer){
...
$(_1f2).__tooltip("arrow").css("left",tip._outerWidth()/2+pos.left);
pos.left=0;
}
}else{
...
$(_1f2).__tooltip("arrow").css("left",tip._outerWidth()/2-(pos.left-left));
}
}
}
}
...
tip.removeClass("__tooltip-top __tooltip-bottom __tooltip-left __tooltip-right").addClass("__tooltip-"+opts.position);
var left,top;
if(opts.trackMouse){
t=$();
...
var _1f8=$.data(_1f7,"__tooltip");
var opts=_1f8.options;
var tip=_1f8.tip;
if(!tip){
tip=$("<div tabindex=\"-1\" class=\"__tooltip\">"+"<div class=\"__tooltip-content\"></div>"+"<div class=\"__tooltip-arrow-outer\"></div>"+"<div class=\"__tooltip-arrow\"></div>"+"</div>").appendTo("body");
_1f8.tip=tip;
_1f9(_1f7);
}
_1ee(_1f7);
_1f8.showTimer=setTimeout(function(){
$(_1f7).__tooltip("reposition");
tip.show();
opts.onShow.call(_1f7,e);
var _1fa=tip.children(".__tooltip-arrow-outer");
var _1fb=tip.children(".__tooltip-arrow");
...
_201.tip.children(".__tooltip-content").html(cc);
opts.onUpdate.call(_1ff,cc);
};
function _202(_203){
var _204=$.data(_203,"__tooltip");
if(_204){
_1ee(_203);
...
$.removeData(_203,"__tooltip");
$(_203).unbind(".__tooltip").removeClass("__tooltip-f");
opts.onDestroy.call(_203);
}
};
$.fn.__tooltip=function(_205,_206){
if(typeof _205=="string"){
return $.fn.__tooltip.methods[_205](this,_206);
}
_205=_205||{};
return this.each(function(){
var _207=$.data(this,"__tooltip");
if(_207){
$.extend(_207.options,_205);
}else{
$.data(this,"__tooltip",{options:$.extend({},$.fn.__tooltip.defaults,$.fn.__tooltip.parseOptions(this),_205)});
init(this);
}
_1ec(this);
_1f9(this);
...
$.fn.__tooltip.methods={options:function(jq){
return $.data(jq[0],"__tooltip").options;
},tip:function(jq){
return $.data(jq[0],"__tooltip").tip;
},arrow:function(jq){
return jq.__tooltip("tip").children(".__tooltip-arrow-outer,.__tooltip-arrow");
},show:function(jq,e){
return jq.each(function(){
_1f6(this,e);
});
...
$.fn.__tooltip.parseOptions=function(_209){
var t=$(_209);
...
$.fn.__tooltip.defaults={position:"bottom",content:null,trackMouse:false,deltaX:0,deltaY:0,showEvent:"mouseenter",hideEvent:"mouseleave",showDelay:200,hideDelay:100,onShow:function(e){
},onHide:function(e){
...
t.find(".__tooltip-f").each(function(){
...
$(_452).__tooltip($.extend({},opts.tipOptions,{content:_453.message,position:opts.tipPosition,deltaX:opts.deltaX})).__tooltip("show");
_453.tip=true;
};
function _447(_454){
var _455=$.data(_454,"validatebox");
if(_455&&_455.tip){
$(_454).__tooltip("reposition");
}
};
function _44b(_456){
...
$(this).__tooltip("tip").css({color:"#000",borderColor:"#CC9933",backgroundColor:"#FFFFCC"});
},onHide:function(){
$(this).__tooltip("destroy");
