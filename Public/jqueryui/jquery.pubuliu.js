;(function($){
   ...
   function creatColumn(){//创建列
	  ...
	  for(var i=0;i<waterfall.column_num;i++){
	     ...
	     html+='<div class="'+setting.column_className+'" style="display:inline-block; *display:inline;zoom:1; margin-left:'+setting.column_space/2+'px;margin-right:'+setting.column_space/2+'px; vertical-align:top; overflow:hidden"></div>';
	  }
