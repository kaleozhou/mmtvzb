var LR_websiteid = 'DDT25102176';
if(typeof(LR_showfloat)=='undefined' || LR_showfloat!=1)var LR_showfloat = 1;
var LR_afd1a='2B75373158904A98A75C9B4BF48E3654';var LR_imgurl = 'http://ddt.zoosnet.net/';
var LR_sysurl = 'http://ddt.zoosnet.net/';
var LR_siteid = '25102176';
var LR_8ea9c=LR_afd1a.replace(/4/g,'8').replace(/5/g,'3');LR_8ea9c=LR_8ea9c.replace(/A/g,'B').replace(/C/g,'D').replace(/E/g,'F').replace(/G/g,'H').replace(/I/g,'J').replace(/K/g,'L');var LR_ssl = 0;
var LR_lxurl = 'http://ddt.zoosnet.net/';
...
var LR_isMobile = 0;
var LR_lng = 'cn';
LR_8ea9c=((4+3).toString()+LR_8ea9c+(4*3).toString());var LR_GEME=LR_8ea9c.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	...
	var _lr_helpsrc_on=unescape("http%3a%2f%2fddt.zoosnet.net%2fsite%2f25102176%2fonlineimgsrc_cn.png");
	...
	var _lr_helpsrc_of=unescape("http%3a%2f%2fddt.zoosnet.net%2fsite%2f25102176%2fofflineimgsrc_cn.png");
	...
	LR_hasInstall=0;
	var LR_ivite_img='http://ddt.zoosnet.net/js/jy_Pink/p.gif';
	var LR_invite_color0='#FF79B2';
	var LR_invite_color1='#FFDEE9';
	var LR_invite_color2='#FF8BB2';
...
var data='id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&AFOD='+LR_GEME;
...
checkcount=-1;LR_inviteimgJS=0;LR_hcloopJS(LR_sysurl+'js/JS_Float.aspx',data);LR_explain='';
		...
		var minichathtml1=(typeof(minichathtml)!='function');if(minichathtml1)document.write('<link href="http://ddt.zoosnet.net/js/JS5.css" rel="stylesheet" type="text/css" />');
