...
class WechatAuth {
    ...
    public function getJsApiTicket() {
        ...
        //如果是企业账号请用以下方法
        //return $this->api('ticket/get_jsapi_ticket','','GET', $param);
     ...
     * @return [type] [description]
    */
    public function sendGroup($data) {
        //发送的POST数据
        $param = array(
            'access_token' => $this->accessToken,
        );
        return $this->api('message/mass/send',$data,'POST',$param);
    }
}
