...
return array(
	...
	//在线报名
	'_BM_EXISTS_'   => '您的数据已经提交成功，我们会尽快与联系您！',
	'_BM_SUCCESS_'  => '数据提交成功！',
	'_BM_ERROR_'    => '数据提交失败，请重试！',
	'_NAME_MUST_'   => '姓名必须填写！',
	'_TEL_MUST_'   => '联系电话必须填写！',
	'_EMAIL_MUST_'   => '邮件必须填写！',
	...
	//注册界面
	'_USER_NAME_EXIST' => '会员昵称已经被占用！',
	'_USER_MOBILE_EXIST' => '手机号已经注册过！',
	'_USER_REGISTER_SUCCESS' => '注册成功！',
	'_USER_INFO_EMPTY' => '会员昵称或手机号不得为空！',
